...
public class WorldManagementController {
    ...
    @PostMapping("")
    public ResponseEntity<?> save(@Valid @RequestBody WorldRQDTO world) throws ServiceException {
        return ResponseEntity.ok(worldMapper.toRSDTO(worldService.save(worldMapper.toIDTO(world))));
    }

    @PatchMapping("")
    public ResponseEntity<?> update(@Valid @RequestBody WorldRQDTO world, @RequestParam String id) throws ServiceException {
        return ResponseEntity.ok(worldMapper.toRSDTO(worldService.update(worldMapper.toIDTO(world, id))));
    }

    @DeleteMapping("")
    public ResponseEntity<?> removeWorld(@RequestParam String id) throws ServiceException {
    ...
    @PostMapping("/places")
    public ResponseEntity<?> save(@Valid @RequestBody PlaceRQDTO place) throws ServiceException {
        return ResponseEntity.ok(placeMapper.toRSDTO(placeService.save(placeMapper.toIDTO(place))));
    }

    @PatchMapping("/places")
    public ResponseEntity<?> update(@Valid @RequestBody PlaceRQDTO place, @RequestParam String id) throws ServiceException {
        return ResponseEntity.ok(placeMapper.toRSDTO(placeService.update(placeMapper.toIDTO(place, id))));
    }

    @DeleteMapping("/places")
    public ResponseEntity<?> removePlace(@RequestParam String id) throws ServiceException {
